...
def log_gpu_memory(device: str, label: str = ""):
    ...
    if device == "cuda":
        ...
        logging.info(f"{prefix}GPU: {allocated:.2f} GB alocado, {reserved:.2f} GB reservado")
...
def setup_output_directory(base_dir: Optional[Path] = None, subdir: str = "output_audio") -> Path:
    """
